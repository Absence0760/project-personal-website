			...
			>
				<div class="project-card">
					...
					<div class="project-links">
						...
						>
							<svg class="project-icon" viewBox="0 0 16 16" width="15" height="15" fill="currentColor" aria-hidden="true">
								<path
						...
						{#if project.url}
							...
							>
								<svg class="project-icon" viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
